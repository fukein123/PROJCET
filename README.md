# zero1.0 - 社区志愿服务管理系统（CVS）

前后端分离项目，包含：

- `backend`: Spring Boot 3.5 + MyBatis-Plus + JWT + Spring Security + SpringDoc OpenAPI
- `admin`: Vue 3 + Element Plus + TypeScript + Pinia + Vue Router + Axios + ECharts
- `skills`: 项目内已安装的辅助开发 skills
...
- `user.name = fukexin123`
- `user.email = 3547795196@qq.com`
