...
**Approval Gate**: `tasks.md` may be created only after the upstream artifact approval has been recorded locally through `scripts/local-approval.ps1` from a user chat reply.
...
- [ ] T004 Validate frontend-backend separation boundaries from plan.md
- [ ] T005 Define skill-first execution list (existing skills first, minimal new installs only)
- [ ] T006 Define feature-level TDD strategy (test-first order, expected failing tests, pass criteria)
...
- [ ] T013 Define shared UX consistency rules for core flows
...
- [ ] T022 [US1] Verify UX consistency against shared rules
...
- [ ] T029 [US2] Verify UX consistency against shared rules
...
- [ ] T035 [US3] Verify UX consistency against shared rules
